...
.pd-shop-category-bar{display:flex;align-items:center;justify-content:space-between;gap:18px;margin:0 0 22px}
.pd-shop-category-list{display:flex;align-items:center;gap:10px;min-width:0;overflow-x:auto;scrollbar-width:none}
...
.pd-shop-sort{flex:0 0 190px;min-height:48px;padding:0 44px 0 18px;border:1px solid #ded7cf;border-radius:16px;background:#fff;color:#17120d;font-family:inherit;font-size:14px;font-weight:800;cursor:pointer}
...
.pd-shop-category-bar{gap:10px;margin:0 0 14px}
.pd-shop-category-list{gap:8px}
.pd-shop-category-pill{min-height:38px;padding:0 16px;font-size:13px}
.pd-shop-sort{flex:0 0 132px;min-height:40px;padding:0 30px 0 12px;border-radius:13px;font-size:12px}
