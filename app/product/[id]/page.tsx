...
const rawStock = numberValue(record.stock_qty ?? record.stock_quantity);
  ...
  const increaseQuantity = () => {
    if (!inStock || qty >= maximumQuantity) return;
