...
const submitReview = async (event: FormEvent<HTMLFormElement>) => {
  ...
  return (
    <main className="pd-page">
      {mainCategoryText && (
        <div className="pd-main-category" aria-label="Product category">
          {mainCategoryText}
        </div>
      )}
...
>
      ...
      <style jsx global>{`
        ...
        .pd-page{max-width:1240px;margin:0 auto;padding:24px 24px 0;color:#17120d}.pd-main-category{margin:0 0 14px;font-size:18px;line-height:1.2;font-weight:900;color:#17120d}.pd-top{display:flex;justify-content:space-between;margin-bottom:22px}.pd-top button,.pd-top a{display:inline-flex;align-items:center;gap:7px;border:0;background:#fff;color:#17120d;text-decoration:none;padding:10px 14px;border-radius:999px;font-weight:800;box-shadow:0 6px 22px rgba(37,24,12,.08);cursor:pointer}.pd-top svg{width:18px}.pd-main{position:relative;display:grid;grid-template-columns:minmax(0,1.06fr) minmax(380px,.94fr);gap:48px;align-items:start}.pd-image{position:relative;width:100%;aspect-ratio:4/5;border-radius:26px;background:#eee center/cover no-repeat;box-shadow:0 14px 45px rgba(37,24,12,.1)}.pd-discount-chip{position:absolute;left:16px;top:16px;padding:8px 11px;border-radius:10px;background:#f1b46d;color:#181008;font-size:12px;font-weight:900}
