    ...
    return (
      <>
        ...
        <style jsx global>{`
          ...
          /* =========================================================
             BUSINESS PAGE MOBILE — FINAL WIDTH + CARD ALIGNMENT FIX
             Scoped only to the business page. The /shop page is unchanged.
          ========================================================= */
          @media (max-width: 700px) {
            .business-page {
              width: 100% !important;
            ...
            .business-page .product-card.rich,
            .business-page .business-loader-product {
              width: 100% !important;
              max-width: 100% !important;
              min-width: 0 !important;
              margin: 0 !important;
            ...
            .business-page .product-title-link,
            .business-page .product-title-link h3 {
              min-width: 0 !important;
              max-width: 100% !important;
              overflow-wrap: anywhere !important;
            }

            .business-page .product-stock-row {
              width: 100% !important;
              min-width: 0 !important;
            ...
            .business-page .product-stock-row .delivery-chip {
              min-width: 0 !important;
            ...
            .business-page .product-stock-row small {
            ...
            .business-page .price strong,
            .business-page .price del,
            .business-page .price span,
            .business-page .reward-row {
              min-width: 0 !important;
              max-width: 100% !important;
              overflow-wrap: anywhere !important;
            }

            .business-page .product-actions {
              width: 100% !important;
              min-width: 0 !important;
              display: grid !important;
            ...
            .business-page .product-compare-online,
            .business-page .product-add-button {
              min-width: 0 !important;
              max-width: 100% !important;
              margin: 0 !important;
            ...
            .business-page .product-compare-online svg,
            .business-page .product-add-button svg {
              flex: 0 0 auto !important;
