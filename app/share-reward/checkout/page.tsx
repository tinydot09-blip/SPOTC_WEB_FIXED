    ...
    <main className="sr-checkout-page">
      <section className="sr-shell">
        ...
        <section className="sr-product">
          ...
          <div>
            <small>YOUR SELECTED GIFT</small>
